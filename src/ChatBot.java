public class ChatBot {
    ...
    //method that calculates the user's age
    ...
    //method that prints the user's height
    public String printHeight(Double height)
    {
        return "Your height is "+height+ " centimeters.";
    }
}
